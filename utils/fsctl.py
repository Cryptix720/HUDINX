...
# HUDINX file system pickle files.
#
...
class fseditCmd(cmd.Cmd):
    ...
    def help_about(self):
        print "hudinx stores information about its file systems in a " + \
            "series of nested lists. Once the lists are made, they are " + \
            "stored in a pickle file on the hard drive. Every time hudinx " + \
            "gets a new client, it reads from the pickle file and loads " + \
            "the fake filesystem into memory. By default this file " + \
            "is /opt/hudinx/fs.pickle. Originally the script " + \
            "/opt/hudinx/createfs.py was used to copy the filesystem " + \
            ...
            "hudinx process in order for the new file system to be " + \
